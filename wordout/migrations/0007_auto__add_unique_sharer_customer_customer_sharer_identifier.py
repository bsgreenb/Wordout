...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Sharer', fields ['customer', 'customer_sharer_identifier']
        db.create_unique('wordout_sharer', ['customer_id', 'customer_sharer_identifier'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Sharer', fields ['customer', 'customer_sharer_identifier']
        db.delete_unique('wordout_sharer', ['customer_id', 'customer_sharer_identifier'])
    ...
    models = {
        ...
        'wordout.sharer': {
            'Meta': {'unique_together': "(('customer', 'customer_sharer_identifier'),)", 'object_name': 'Sharer'},
            'code': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '8', 'db_index': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'customer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['wordout.Customer']"}),
            'customer_sharer_identifier': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'enabled': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
