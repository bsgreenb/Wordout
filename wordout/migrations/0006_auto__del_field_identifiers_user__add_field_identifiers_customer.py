...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Identifiers.user'
        db.delete_column('wordout_identifiers', 'user_id')

        # Adding field 'Identifiers.customer'
        db.add_column('wordout_identifiers', 'customer', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['wordout.Customer']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Identifiers.user'
        db.add_column('wordout_identifiers', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.date(2011, 11, 25), to=orm['auth.User']), keep_default=False)

        # Deleting field 'Identifiers.customer'
        db.delete_column('wordout_identifiers', 'customer_id')
