...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Customer', fields ['client_id']
        db.create_unique('wordout_customer', ['client_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Customer', fields ['client_id']
        db.delete_unique('wordout_customer', ['client_id'])
