...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Identifiers.identifier_type'
        db.delete_column('wordout_identifiers', 'identifier_type')

        # Changing field 'Identifiers.identifier'
        db.alter_column('wordout_identifiers', 'identifier', self.gf('django.db.models.fields.IntegerField')(max_length=10))


    def backwards(self, orm):
        
        # Adding field 'Identifiers.identifier_type'
        db.add_column('wordout_identifiers', 'identifier_type', self.gf('django.db.models.fields.CharField')(default=0, max_length=1), keep_default=False)

        # Changing field 'Identifiers.identifier'
        db.alter_column('wordout_identifiers', 'identifier', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    models = {
        ...
        'wordout.identifiers': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.IntegerField', [], {'max_length': '10'}),
