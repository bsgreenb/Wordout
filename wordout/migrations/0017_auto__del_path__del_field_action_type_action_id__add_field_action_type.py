...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Action_Type.customer_action_type_identifier'
        db.add_column('wordout_action_type', 'customer_action_type_identifier', self.gf('django.db.models.fields.IntegerField')(default=10, max_length=2), keep_default=False)

        # Changing field 'Customer.api_key'
        db.alter_column('wordout_customer', 'api_key', self.gf('django.db.models.fields.CharField')(unique=True, max_length=30))

        # Deleting field 'Action.action'
        db.delete_column('wordout_action', 'action_id')

        # Adding field 'Action.action_type'
        db.add_column('wordout_action', 'action_type', self.gf('django.db.models.fields.related.ForeignKey')(default=12, to=orm['wordout.Action_Type']), keep_default=False)

        # Renaming column for 'Full_Link.path' to match new field type.
        db.rename_column('wordout_full_link', 'path_id', 'path')
        # Changing field 'Full_Link.path'
        db.alter_column('wordout_full_link', 'path', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Removing index on 'Full_Link', fields ['path']
        db.delete_index('wordout_full_link', ['path_id'])

        # Deleting field 'Sharer.customer_sharer_id'
        db.delete_column('wordout_sharer', 'customer_sharer_id')

        # Adding field 'Sharer.customer_sharer_identifier'
        db.add_column('wordout_sharer', 'customer_sharer_identifier', self.gf('django.db.models.fields.IntegerField')(default=1, max_length=10), keep_default=False)


    def backwards(self, orm):
        
        # Adding index on 'Full_Link', fields ['path']
        db.create_index('wordout_full_link', ['path_id'])
        ...
        db.add_column('wordout_action_type', 'action_id', self.gf('django.db.models.fields.IntegerField')(default=12, max_length=2), keep_default=False)

        # Deleting field 'Action_Type.customer_action_type_identifier'
        db.delete_column('wordout_action_type', 'customer_action_type_identifier')

        # Changing field 'Customer.api_key'
        db.alter_column('wordout_customer', 'api_key', self.gf('django.db.models.fields.CharField')(max_length=9, unique=True))

        # Adding field 'Action.action'
        db.add_column('wordout_action', 'action', self.gf('django.db.models.fields.related.ForeignKey')(default=11, to=orm['wordout.Action_Type']), keep_default=False)

        # Deleting field 'Action.action_type'
        db.delete_column('wordout_action', 'action_type_id')

        # Renaming column for 'Full_Link.path' to match new field type.
        db.rename_column('wordout_full_link', 'path', 'path_id')
        # Changing field 'Full_Link.path'
        db.alter_column('wordout_full_link', 'path_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wordout.Path']))

        # Adding field 'Sharer.customer_sharer_id'
        db.add_column('wordout_sharer', 'customer_sharer_id', self.gf('django.db.models.fields.IntegerField')(default=13, max_length=10), keep_default=False)

        # Deleting field 'Sharer.customer_sharer_identifier'
        db.delete_column('wordout_sharer', 'customer_sharer_identifier')
