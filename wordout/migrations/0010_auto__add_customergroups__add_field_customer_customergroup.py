...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Customer.customergroup'
        db.add_column('wordout_customer', 'customergroup', self.gf('django.db.models.fields.related.ForeignKey')(default=10000, to=orm['wordout.Customergroups']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Customer.customergroup'
        db.delete_column('wordout_customer', 'customergroup_id')
    ...
    models = {
        ...
        'wordout.customer': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '9'}),
