...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Customer.redirect_link'
        db.add_column('wordout_customer', 'redirect_link', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='customer_default_redirect_link', null=True, to=orm['wordout.Full_Link']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Customer.redirect_link'
        db.delete_column('wordout_customer', 'redirect_link_id')
