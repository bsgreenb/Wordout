...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Action_Type.customer_action_type_identifier'
        db.alter_column('wordout_action_type', 'customer_action_type_identifier', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=2))

        # Changing field 'Customergroup.max_actions'
        db.alter_column('wordout_customergroup', 'max_actions', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=2))

        # Changing field 'Customergroup.max_users'
        db.alter_column('wordout_customergroup', 'max_users', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=10))

        # Changing field 'Sharer.customer_sharer_identifier'
        db.alter_column('wordout_sharer', 'customer_sharer_identifier', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=10))


    def backwards(self, orm):
        
        # Changing field 'Action_Type.customer_action_type_identifier'
        db.alter_column('wordout_action_type', 'customer_action_type_identifier', self.gf('django.db.models.fields.IntegerField')(max_length=2))

        # Changing field 'Customergroup.max_actions'
        db.alter_column('wordout_customergroup', 'max_actions', self.gf('django.db.models.fields.IntegerField')(max_length=2))

        # Changing field 'Customergroup.max_users'
        db.alter_column('wordout_customergroup', 'max_users', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'Sharer.customer_sharer_identifier'
        db.alter_column('wordout_sharer', 'customer_sharer_identifier', self.gf('django.db.models.fields.IntegerField')(max_length=10))
