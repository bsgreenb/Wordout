...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('wordout_sharer', 'customer_sharer_identifier', self.gf('django.db.models.fields.CharField')(max_length=50))


    def backwards(self, orm):
        
        # Changing field 'Sharer.customer_sharer_identifier'
        db.alter_column('wordout_sharer', 'customer_sharer_identifier', self.gf('django.db.models.fields.CharField')(max_length=2000))
