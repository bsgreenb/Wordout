...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Customergroup.max_actions'
        db.add_column('wordout_customergroup', 'max_actions', self.gf('django.db.models.fields.IntegerField')(default=5, max_length=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Customergroup.max_actions'
        db.delete_column('wordout_customergroup', 'max_actions')
