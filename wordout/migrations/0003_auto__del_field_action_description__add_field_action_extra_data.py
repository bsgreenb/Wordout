...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('wordout_action', 'description')

        # Adding field 'Action.extra_data'
        db.add_column('wordout_action', 'extra_data', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Action.description'
        db.add_column('wordout_action', 'description', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True), keep_default=False)

        # Deleting field 'Action.extra_data'
        db.delete_column('wordout_action', 'extra_data')
